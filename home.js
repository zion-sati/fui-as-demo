  ...
  const adaptedImports = {
    ...
    fui_host: Object.setPrototypeOf({
      ...
      fui_load_texture(textureId, ptr, len) {
        // ~lib/@effindomv2/fui-as/src/core/generated/HostAbi/fui_load_texture(u32, usize, u32) => void
        textureId = textureId >>> 0;
        ptr = ptr >>> 0;
        len = len >>> 0;
      ...
      fui_load_svg(svgId, ptr, len) {
        // ~lib/@effindomv2/fui-as/src/core/generated/HostAbi/fui_load_svg(u32, usize, u32) => void
        svgId = svgId >>> 0;
        ptr = ptr >>> 0;
        len = len >>> 0;
    ...
    effindom_v2_ui: Object.setPrototypeOf({
      ...
      ui_clear_selection(text_node_handle) {
        // ~lib/@effindomv2/fui-as/src/core/generated/UiAbi/ui_clear_selection(u64) => void
        text_node_handle = BigInt.asUintN(64, text_node_handle);
        __module1.ui_clear_selection(text_node_handle);
      },
      ui_retarget_selection(from_text_node_handle, to_text_node_handle) {
        // ~lib/@effindomv2/fui-as/src/core/generated/UiAbi/ui_retarget_selection(u64, u64) => void
        from_text_node_handle = BigInt.asUintN(64, from_text_node_handle);
        to_text_node_handle = BigInt.asUintN(64, to_text_node_handle);
        __module1.ui_retarget_selection(from_text_node_handle, to_text_node_handle);
      },
