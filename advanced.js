  ...
  const adaptedImports = {
    ...
    fui_host: Object.setPrototypeOf({
      ...
      fui_worker_start_string(workerId, entryPtr, entryLen, inputPtr, inputLen) {
        // ~lib/@effindomv2/fui-as/src/core/ffi/fui_worker_start_string(u32, usize, u32, usize, u32) => void
        workerId = workerId >>> 0;
        entryPtr = entryPtr >>> 0;
        entryLen = entryLen >>> 0;
        inputPtr = inputPtr >>> 0;
        inputLen = inputLen >>> 0;
        __module0.fui_worker_start_string(workerId, entryPtr, entryLen, inputPtr, inputLen);
      },
      ...
      fui_file_process_worker_start(requestId, fileIdPtr, fileIdLen, suggestedNamePtr, suggestedNameLen, chunkBytes, saveToPickedFile) {
        // ~lib/@effindomv2/fui-as/src/core/ffi/fui_file_process_worker_start(u32, usize, u32, usize, u32, u32, bool) => void
        ...
        __module0.fui_file_process_worker_start(requestId, fileIdPtr, fileIdLen, suggestedNamePtr, suggestedNameLen, chunkBytes, saveToPickedFile);
      },
    ...
    fui_fetch_host: Object.setPrototypeOf({
      ...
      fui_fetch_start(requestId, methodPtr, methodLen, urlPtr, urlLen, headersPtr, headersLen, bodyPtr, bodyLen) {
        // ~lib/@effindomv2/fui-as/src/core/FetchFfi/fui_fetch_start(u32, usize, u32, usize, u32, usize, u32, usize, u32) => void
        requestId = requestId >>> 0;
