  ...
  const adaptedImports = {
    ...
    fui_host: Object.setPrototypeOf({
      ...
      fui_worker_start_string(workerId, wasmPathPtr, wasmPathLen, entryPtr, entryLen, inputPtr, inputLen) {
        // ~lib/@effindomv2/fui-as/src/core/generated/HostAbi/fui_worker_start_string(u32, usize, u32, usize, u32, usize, u32) => void
        workerId = workerId >>> 0;
        wasmPathPtr = wasmPathPtr >>> 0;
        wasmPathLen = wasmPathLen >>> 0;
        entryPtr = entryPtr >>> 0;
        entryLen = entryLen >>> 0;
        inputPtr = inputPtr >>> 0;
        inputLen = inputLen >>> 0;
        __module0.fui_worker_start_string(workerId, wasmPathPtr, wasmPathLen, entryPtr, entryLen, inputPtr, inputLen);
      },
      ...
      fui_file_process_worker_start(requestId, workerWasmPathPtr, workerWasmPathLen, workerEntryPtr, workerEntryLen, fileIdPtr, fileIdLen, suggestedNamePtr, suggestedNameLen, chunkBytes, saveToPickedFile) {
        // ~lib/@effindomv2/fui-as/src/core/generated/HostAbi/fui_file_process_worker_start(u32, usize, u32, usize, u32, usize, u32, usize, u32, u32, bool) => void
        requestId = requestId >>> 0;
        workerWasmPathPtr = workerWasmPathPtr >>> 0;
        workerWasmPathLen = workerWasmPathLen >>> 0;
        workerEntryPtr = workerEntryPtr >>> 0;
        workerEntryLen = workerEntryLen >>> 0;
        fileIdPtr = fileIdPtr >>> 0;
        fileIdLen = fileIdLen >>> 0;
        suggestedNamePtr = suggestedNamePtr >>> 0;
        suggestedNameLen = suggestedNameLen >>> 0;
        chunkBytes = chunkBytes >>> 0;
        saveToPickedFile = saveToPickedFile != 0;
        __module0.fui_file_process_worker_start(requestId, workerWasmPathPtr, workerWasmPathLen, workerEntryPtr, workerEntryLen, fileIdPtr, fileIdLen, suggestedNamePtr, suggestedNameLen, chunkBytes, saveToPickedFile);
      },
    ...
    fui_fetch_host: Object.setPrototypeOf({
      ...
      fui_fetch_start(requestId, methodPtr, methodLen, urlPtr, urlLen, headersPtr, headersLen, bodyPtr, bodyLen) {
        // ~lib/@effindomv2/fui-as/src/core/generated/FetchHostAbi/fui_fetch_start(u32, usize, u32, usize, u32, usize, u32, usize, u32) => void
        requestId = requestId >>> 0;
        methodPtr = methodPtr >>> 0;
        methodLen = methodLen >>> 0;
        urlPtr = urlPtr >>> 0;
        urlLen = urlLen >>> 0;
        headersPtr = headersPtr >>> 0;
        headersLen = headersLen >>> 0;
        bodyPtr = bodyPtr >>> 0;
        bodyLen = bodyLen >>> 0;
        __module2.fui_fetch_start(requestId, methodPtr, methodLen, urlPtr, urlLen, headersPtr, headersLen, bodyPtr, bodyLen);
      },
    }, __module2),
  };
...
))(new URL("advanced.wasm", import.meta.url));
