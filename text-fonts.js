  ...
  const adaptedImports = {
    ...
    fui_host: Object.setPrototypeOf({
      ...
      fui_load_font(fontId, ptr, len) {
        // ~lib/@effindomv2/fui-as/src/core/generated/HostAbi/fui_load_font(u32, usize, u32) => void
        fontId = fontId >>> 0;
        ptr = ptr >>> 0;
        len = len >>> 0;
        __module0.fui_load_font(fontId, ptr, len);
      },
    ...
    effindom_v2_ui: Object.setPrototypeOf({
      ...
      ui_replace_text_range(handle, start_idx, end_idx, utf8_str, len, caret_idx) {
        // ~lib/@effindomv2/fui-as/src/core/generated/UiAbi/ui_replace_text_range(u64, u32, u32, usize, u32, u32) => void
        handle = BigInt.asUintN(64, handle);
        start_idx = start_idx >>> 0;
        end_idx = end_idx >>> 0;
        utf8_str = utf8_str >>> 0;
        len = len >>> 0;
        caret_idx = caret_idx >>> 0;
        __module1.ui_replace_text_range(handle, start_idx, end_idx, utf8_str, len, caret_idx);
      },
    }, __module1),
...
))(new URL("text-fonts.wasm", import.meta.url));
